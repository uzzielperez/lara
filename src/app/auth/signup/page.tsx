    ...
    <div className="min-h-[80vh] flex items-center justify-center animate-fade-in">
      <div className="bg-white rounded-2xl shadow-lg border border-cream-300 p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-charcoal-light">Start your study abroad journey today</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p className="text-xs text-charcoal-light mt-1">At least 6 characters</p>
          </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-charcoal-light">Or continue with</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-charcoal-light mt-6">
          ...
          <Link href="/auth/signin" className="text-teal font-medium hover:underline">
            Sign in
          </Link>
        </p>
      </div>
